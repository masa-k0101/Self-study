...
#csvファイルを読み込み
data = sp.genfromtxt(rfile, comments='#' ,delimiter=',')
...
#最小二乗法(１次)計算
x1 = sp.linspace(0,x[-1],1000)
a,b = sp.polyfit(x,y,1)
y1 = a*x1 + b

#最小二乗法(2次)計算
a2,b2,c2 = sp.polyfit(x,y,2)
y2 = a2*x1*x1 + b2*x1 + c2
...
plt.text(0.1,a2*0.1+b2, 'y='+ str(round(a,4)) +'x+'+str(round(b,4)))
