...
#! python3
# randomQuizeGenerator.py - ランダム順に問題と答えを並べ問題集と解答集を作る
...
for quiz_num in range(5):
    ...
    answer_key_file = open('capitalquiz_answer{}.txt'.format(quiz_num + 1), 'w')
